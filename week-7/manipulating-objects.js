...
//I had issues passing when it came to adding carson property to the value of the terah children property. I had issues wrapping my head around what they wanted, creating an object within an object, but after some research and looking around, it makes sense now.

// How difficult was it to add and delete properties outside of the object itself?

// It was quite easy to add and delete properties outside of the object, once learning how to do it in the first place, its quite simple.

// What did you learn about manipulating objects in this challenge?

// I learned how to add and delete properties outside of the objects, which will be quite helpful, also solidified objects inside objects.
